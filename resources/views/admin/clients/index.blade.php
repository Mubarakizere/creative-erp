...
<div class="flex items-center justify-end gap-2">
                            ...
                            @can('view', $client)
                                <a href="{{ route('admin.clients.show', $client) }}" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors flex items-center justify-center" title="View">
<svg class="w-4 h-4 mr-3 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @if(!$client->trashed())
                                @can('update', $client)
                                    <a href="{{ route('admin.clients.edit', $client) }}" class="p-1.5 text-gray-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors flex items-center justify-center" title="Edit">
<svg class="w-4 h-4 mr-3 " fill="none" stroke="currentColor" viewBox="0 0 24 24">

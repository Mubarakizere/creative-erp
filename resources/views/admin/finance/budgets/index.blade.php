                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                ...
                                <td class="py-4 px-6 text-right whitespace-nowrap">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        @can('delete', $budget)
                                            <form action="{{ route('admin.finance.budgets.destroy', $budget) }}" method="POST" id="form-delete-budget-{{ $budget->id }}" class="hidden">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            <button type="button" 
                                                    @click="$dispatch('open-modal', 'delete-budget-{{ $budget->id }}')" 

<x-layouts.admin title="Edit Account">
    ...
    <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-gray-500">Update the details for {{ $chartOfAccount->name }} ({{ $chartOfAccount->code }}).</p>
    </div>

    <x-card>
        <form method="POST" action="{{ route('admin.finance.accounting.chart-of-accounts.update', $chartOfAccount) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('description', $chartOfAccount->description) }}</textarea>
            ...
            <div class="flex items-center">
                ...
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $chartOfAccount->is_active) ? 'checked' : '' }}

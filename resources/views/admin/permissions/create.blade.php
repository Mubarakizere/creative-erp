    ...
    <div class="mb-8 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Add a new permission for the application.</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.permissions.store') }}" method="POST">
            ...
            <x-card>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <x-input name="name" value="{{ old('name') }}" placeholder="e.g. project.create" required />
                        <p class="mt-1 text-xs text-gray-500">Convention: <code>module.action</code> (e.g. <code>user.view</code>, <code>company.delete</code>)</p>
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <x-button type="submit" color="primary">Save Permission</x-button>
            </div>
        </form>
    </div>
</x-layouts.admin>

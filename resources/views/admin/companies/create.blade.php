                    ...
                    <div x-data="{ preview: null }" class="space-y-1.5">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex-shrink-0">
                                ...
                                <img x-show="preview" :src="preview" class="w-16 h-16 rounded-xl object-cover border border-gray-200" style="display: none;" />
                            </div>
                            <div class="flex-1">

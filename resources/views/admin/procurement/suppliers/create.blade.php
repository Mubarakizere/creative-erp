<x-layouts.admin title="Add Supplier">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Add Supplier</h1>
            <p class="mt-1 text-sm text-gray-500 font-medium">Create a new supplier in the system.</p>
        </div>
    </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6">
                        ...
                        <div class="col-span-1 sm:col-span-2 lg:col-span-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors">
                            @error('name') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>

                        <div class="col-span-1 sm:col-span-2 lg:col-span-3">
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors">
                        ...
                        <div class="col-span-1 sm:col-span-2 lg:col-span-6 mt-2">
                            <div class="flex items-start">
                                <div class="flex h-6 items-center">
                                    <input type="checkbox" name="is_preferred" id="is_preferred" value="1" {{ old('is_preferred') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-600 transition-colors">
                                </div>
    ...
    <div class="text-center py-16 bg-white rounded-2xl border border-gray-200/60 shadow-sm">
        ...
        <p class="text-sm text-gray-500 font-medium">You do not have permission to add suppliers.</p>
        <div class="mt-6">

    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('admin.procurement.requisitions.pdf', $requisition) }}" class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold text-slate-700 bg-white border border-slate-300 hover:bg-slate-50">Export PDF</a>

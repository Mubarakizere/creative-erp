<x-layouts.admin title="Create Cycle Counts">
    <x-slot:breadcrumbs>
        @php
            $breadcrumbs = [
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Create Cycle Counts</h1>
    </div>

    <x-card>
        <form action="{{ route('admin.warehouse.cycle-counts.store') }}" method="POST" class="p-6">
            @csrf

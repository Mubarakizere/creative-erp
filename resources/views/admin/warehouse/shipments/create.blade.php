<x-layouts.admin title="Create Shipments">
    <x-slot:breadcrumbs>
        @php
            $breadcrumbs = [
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Create Shipments</h1>
    </div>

    <x-card>
        <form action="{{ route('admin.warehouse.shipments.store') }}" method="POST" class="p-6">
            @csrf

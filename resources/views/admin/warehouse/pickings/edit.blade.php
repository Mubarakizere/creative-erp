<x-layouts.admin title="Edit Pickings">
    <x-slot:breadcrumbs>
        @php
            $breadcrumbs = [
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Edit Pickings</h1>
    </div>

    <x-card>
        <form action="{{ route('admin.warehouse.pickings.update', $item) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')

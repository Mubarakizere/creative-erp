<x-layouts.admin title="Pickings">
    <x-slot:breadcrumbs>
        @php
            $breadcrumbs = [
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Pickings</h1>
            <p class="mt-1 text-sm text-gray-500">Manage Pickings.</p>
        </div>
        @can('create', App\Models\WarehousePicking::class)
            <x-button type="primary" href="{{ route('admin.warehouse.pickings.create') }}">

<x-layouts.admin title="View Warehouse Bins">
    <x-slot:breadcrumbs>
        @php
            $breadcrumbs = [
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">View Warehouse Bins</h1>
        </div>
        <x-button href="{{ route('admin.warehouse.bins.index') }}">
            Back to List
        </x-button>
    </div>

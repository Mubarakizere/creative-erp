<x-layouts.admin title="Create Warehouse Bins">
    <x-slot:breadcrumbs>
        @php
            $breadcrumbs = [
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Create Warehouse Bins</h1>
    </div>

    <x-card>
        <form action="{{ route('admin.warehouse.bins.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="warehouse_zone_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        ...
                        @foreach($zones as $zone)
                            <option value="{{ $zone->id }}" {{ old('warehouse_zone_id') == $zone->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" required placeholder="e.g. CS-A1-RA-S1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="aisle" value="{{ old('aisle') }}" placeholder="e.g. A1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="rack" value="{{ old('rack') }}" placeholder="e.g. Rack A" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="shelf" value="{{ old('shelf') }}" placeholder="e.g. Shelf 1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="capacity" value="{{ old('capacity', 0) }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">

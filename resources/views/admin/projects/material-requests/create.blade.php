...
<div class="px-4 sm:px-6 lg:px-8" x-data="materialRequestForm()">
    <div class="sm:flex sm:items-center justify-between">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Create Material Request</h1>
    </div>
    ...
    <div class="mt-6">
        <form action="{{ route('admin.material-requests.store') }}" method="POST">
            ...
            <div class="bg-white dark:bg-gray-800 shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Basic information about this material request.</p>
                    </div>
                    <div class="mt-5 md:mt-0 md:col-span-2 space-y-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="date" name="required_date" id="required_date" value="{{ old('required_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea id="purpose" name="purpose" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('purpose') }}</textarea>
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea id="notes" name="notes" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('notes') }}</textarea>
            ...
            <div class="mt-6 flex justify-end">
                <a href="{{ route('admin.material-requests.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</a>
                <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">Create Request</button>
            </div>
        </form>
    </div>
</div>

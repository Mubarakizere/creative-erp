<x-layouts.admin title="Create User">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Register a new user in the system.</p>
        </div>
        <x-button type="ghost" href="{{ route('admin.users.index') }}" size="sm">
        ...
        <div class="space-y-6">
            ...
            <x-card>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-input name="job_title" label="Job Title" />
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="flex items-center gap-4 mt-2">
                            <div class="h-16 w-16 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden border">
                                ...
                                <template x-if="!avatarPreview">
                                    <svg class="h-8 w-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                                </template>
                            </div>
                            <div>
            ...
            <x-card>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="grid grid-cols-2 gap-2 border rounded-lg p-4 bg-gray-50">
                            @foreach($roles as $role)
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="roles[]" value="{{ $role->name }}" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" @checked(is_array(old('roles')) && in_array($role->name, old('roles')))>
                    ...
                    <div class="space-y-6">
                        <x-select name="status" label="Status" :options="['active' => 'Active', 'inactive' => 'Inactive', 'pending' => 'Pending']" selected="active" />
            ...
            <div class="flex items-center justify-end gap-3 pb-6">
                <x-button type="ghost" href="{{ route('admin.users.index') }}">Cancel</x-button>

                            ...
                            <td class="px-6 py-4 text-right">
                                <div x-data="{ open: false }" class="relative inline-block text-left">
                                    ...
                                    <div x-show="open" x-cloak
                                        ...
                                        <a href="{{ route('admin.crm.opportunities.show', $opportunity) }}" class="flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition-colors">
                                        ...
                                        @if(!$opportunity->trashed())
                                            ...
                                            <a href="{{ route('admin.crm.opportunities.edit', $opportunity) }}" class="flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition-colors">
                                            ...
                                            @can('delete', $opportunity)
                                                ...
                                                <button type="button" @click="open = false; $dispatch('open-modal', 'archive-opp-{{ $opportunity->id }}')" class="flex items-center w-full px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors">

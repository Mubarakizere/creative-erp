<x-layouts.admin title="Create Quotation">
    ...
    <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-gray-500">Draft a new sales quotation.</p>
    </div>
            ...
            <div class="space-y-6">
                <x-card>
                    ...
                    <div class="space-y-4">
                        ...
                        <x-input name="currency" label="Currency" value="USD" />
                    </div>
                </x-card>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <x-button type="ghost" href="{{ route('admin.crm.quotations.index') }}" class="w-full justify-center">
                        Cancel
                    </x-button>
                </div>
            </div>

<x-layouts.admin title="Time Tracking">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Monitor all time logs across the company.</p>
        </div>
        ...
        <form method="GET" action="{{ route('admin.time-tracking.index') }}" class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                @if(request()->hasAny(['project_id', 'user_id']))
                    <x-button type="ghost" href="{{ route('admin.time-tracking.index') }}" size="md">Clear</x-button>
                @endif
            </div>
        </form>
    </x-card>
    ...
    <x-table>
            ...
            <tr>
                <td class="px-4 py-3">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-900">{{ $entry->user->full_name }}</p>
        ...
        @empty
            <tr>
                <td colspan="6" class="px-4 py-12 text-center text-gray-500">No time entries found.</td>
            </tr>
        @endforelse

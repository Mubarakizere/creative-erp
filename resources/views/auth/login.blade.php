        ...
        <div>
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                    ...
                    class="block w-full pl-10 sm:text-sm border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 py-3 text-gray-900 bg-gray-50 hover:bg-gray-100 transition-colors"
                >
            </div>
            @error('email')
        ...
        <div>
            ...
            <div class="mt-1 relative rounded-md shadow-sm" x-data="{ showPassword: false }">
                ...
                <input
                    ...
                    placeholder="••••••••"
                    class="block w-full pl-10 pr-10 sm:text-sm border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 py-3 text-gray-900 bg-gray-50 hover:bg-gray-100 transition-colors"
                >
                <button
                    type="button"

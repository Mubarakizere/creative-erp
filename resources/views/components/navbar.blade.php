    ...
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="hidden sm:block relative">
                ...
                <input type="text" placeholder="Search..." class="pl-10 pr-4 py-2 w-64 text-sm bg-gray-100 border-0 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all">
            </div>
        </div>

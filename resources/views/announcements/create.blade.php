<x-layouts.admin title="Create Announcement">
 ...
 <input id="is_pinned" name="is_pinned" type="checkbox" value="1" {{ old('is_pinned') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
 <label for="is_pinned" class="ml-2 block text-sm text-gray-900 ">Pin Announcement</label>
 </div>

 <div class="flex items-center">
 <input id="is_published" name="is_published" type="checkbox" value="1" {{ old('is_published') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
 ...
 <x-button type="primary" submit>Create Announcement</x-button>
 </div>
  </form>
  </x-card>
